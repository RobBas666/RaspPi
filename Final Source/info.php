...
<style>
 ...
 <div class="wrapper" align="center" type="main">
  <img src="pics/BBD-SoftwareDevelopment-White.png" style="width:138px;height:63px;" align="center"> 
  <font style="text-align:$align; color:white; padding:30px 0px 0px 0px; font:32px Oswald; text-shadow:#000 0px 1px 5px; font-family:cambria;" >
	Presenters Info
  </font>
  <p>Enter presenter details below. Press submit after each person.</p>
  <form class="form" method="post" action="insertPresenter.php">
    ...
    <input type="submit" class="submit" style="width:85%;" onclick="Enter()" value="Submit">
    </div>
    <br><br>
    <div class="panel panel-default"  type="table">
    <!-- Default panel contents -->
    <div class="panel-heading" style="font:32px Oswald; color:#28D2DE; background:rgba(0,0,0,0.2); font-family:Cambria;">Presenters</div>
