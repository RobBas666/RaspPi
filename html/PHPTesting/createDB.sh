...
mysql -u root -ppassword <<MY_QUERY
	...
	CREATE TABLE VOTES (VOTEID int(11) NOT NULL AUTO_INCREMENT, RATING int(11) DEFAULT 0, PRESENTER int(11), MAC VARCHAR(20), PRIMARY KEY(VOTEID), FOREIGN KEY(PRESENTER) REFERENCES PRESENTER(PRESENTERID));
